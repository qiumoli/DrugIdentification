...
medications = [
    ...
    },
    {
        ...
        "id": "med_006",
        "name": "妥布霉素地塞米松滴眼液",
        "desc": "【成份】复方制剂，每毫升含妥布霉素3mg、地塞米松1mg，辅料含苯扎氯铵、氯化钠等；【性状】白色或类白色混悬液；【适应症】用于肾上腺皮质激素敏感的眼部疾患及外眼部细菌感染，可治疗结膜炎、角膜炎、睑缘炎等，减轻眼部炎症水肿、瘙痒，也用于眼部术后炎症防治；【规格】5ml：妥布霉素15mg与地塞米松5mg；【用法用量】滴入结膜囊，每次1-2滴，每4-6小时1次，重症前1-2天每2小时1次，用前摇匀；【不良反应】长期用可致眼压升高、青光眼、白内障、视神经损伤，局部可有眼睑瘙痒、结膜充血、烧灼感，还可能诱发真菌、病毒感染；【禁忌】对成分过敏者、眼部病毒/真菌/分枝杆菌感染者、未治疗化脓性眼部感染等禁用；【注意事项】含激素不可长期自行使用，连续用不超2周，儿童、孕妇哺乳期慎用，用药期间禁戴隐形眼镜，开启后4周内用完，仅供滴眼；【贮藏】遮光密闭阴凉干燥处保存；【有效期】24个月"
